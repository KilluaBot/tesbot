...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© Ilham", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© Ilham", log0, btn, thum)
}
